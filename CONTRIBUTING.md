...
*   **Mandatory SemVer Type per Update**: Every update must declare a SemVer type (`patch`, `minor`, or `major`) in `CHANGELOG.md` under the relevant release or unreleased entry.
